...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('arti/index')}}">首页</a> &raquo; <a href="#"></a> &raquo; 全部文章
    </div>
    <!--面包屑导航 结束-->
                ...
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);"  onclick = "deleteArti({{$v['arti_id']}})">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
...
<style>
    ...
    <script>
        function deleteArti(id) {
            //询问框
            layer.confirm('您确认删除吗？', {
                btn: ['是', '否'] //按钮
            }, function () {
                $.ajax({
                    url: "{{url('arti/delete')}}" + '/' + id,
                    //不能写成
                    // url: "{{url('arti/delete/')}}"+ id,
                    type : 'GET',
                    dataType : 'JSON',
