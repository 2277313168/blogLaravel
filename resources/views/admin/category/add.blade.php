...
@section('content')
    ...
    <div class="result_wrap">
        ...
        <form action="{{url('cat/add')}}" method="post">
            {{csrf_field()}}
            <table class="add_tab">
                <tbody>
                <tr>
                ...
                <tr>
                    <th>标题：</th>
                    <td>
                        <input type="text" class="lg" name="cat_title">
                        <p>标题可以写30个字</p>
                    </td>
                </tr>
                ...
                <tr>
                    <th>关键词：</th>
                    <td>
                        <input type="text" class="lg" name="cat_keywords">
                        <p>可以写30个字</p>
                    </td>
                ...
                <tr>
                    <th>分类描述：</th>
                    <td>
                        <input type="text" class="lg" name="cat_desc">
                        <p>可以写30个字</p>
                    </td>
                </tr>
                ...
                <tr>
                    <th>分类排行：</th>
                    <td>
                        <input type="text" class="sm" name="cat_order">
